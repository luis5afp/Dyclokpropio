...
((c.prototype.set = function (t, e, n, r) {
  ...
  (c.prototype.xor = function (t, e, n) {
...
var h = {};
const g = n.getSymbolSize;
h.getPositions = function (t) {
  const e = g(t);
  return [
    [0, 0],
    [e - 7, 0],
...
((p.getBlocksCount = function (t, e) {
  ...
  (p.getTotalCodewordsCount = function (t, e) {
    switch (e) {
      case w.L:
        return E[4 * (t - 1) + 0];
      case w.M:
...
(!(function () {
  let t = 1;
  for (let e = 0; e < 255; e++)
    ((v[e] = t), (C[t] = e), (t <<= 1), 256 & t && (t ^= 285));
  for (let e = 255; e < 512; e++) v[e] = v[e - 255];
})(),
  (A.log = function (t) {
...
((I.prototype.initialize = function (t) {
  ((this.degree = t), (this.genPoly = B.generateECPolynomial(this.degree)));
}),
  (I.prototype.encode = function (t) {
    if (!this.genPoly) throw new Error("Encoder not initialized");
    const e = new Uint8Array(t.length + this.degree);
    e.set(t);
    const n = B.mod(e, this.genPoly),
...
L = L.replace(/u/g, "\\u");
const U = "(?:(?![A-Z0-9 $%*+\\-./:]|" + L + ")(?:.|[\r\n]))+";
((b.KANJI = new RegExp(L, "g")),
  (b.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g")),
  (b.BYTE = new RegExp(U, "g")),
  (b.NUMERIC = new RegExp(R, "g")),
  (b.ALPHANUMERIC = new RegExp("[A-Z $%*+\\-./:]+", "g")));
const x = new RegExp("^" + L + "$"),
  S = new RegExp("^" + R + "$"),
  k = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
  ...
  (function (t) {
    ...
    ((t.from = function (t, e) {
      ...
      (t.getEncodedBits = function (t) {
        ...
        let n = t << 12;
        for (; e.getBCHDigit(n) - u >= 0; ) n ^= 7973 << (e.getBCHDigit(n) - u);
        return (t << 12) | n;
      }));
  })(T));
var F = {};
const z = n,
  D = z.getBCHDigit(1335);
F.getEncodedBits = function (t, e) {
  const n = (t.bit << 3) | e;
  let r = n << 10;
  for (; z.getBCHDigit(r) - D >= 0; ) r ^= 1335 << (z.getBCHDigit(r) - D);
  return 21522 ^ ((n << 10) | r);
};
var H = {};
const J = N;
function K(t) {
  ((this.mode = J.NUMERIC), (this.data = t.toString()));
}
...
function j(t) {
  ((this.mode = _.ALPHANUMERIC), (this.data = t));
}
((j.getBitsLength = function (t) {
  ...
  (j.prototype.write = function (t) {
    ...
    for (e = 0; e + 2 <= this.data.length; e += 2) {
      let n = 45 * V.indexOf(this.data[e]);
      ((n += V.indexOf(this.data[e + 1])), t.put(n, 11));
    }
    ...
    G =
      {
        single_source_shortest_paths: function (t, e, n) {
          ...
          var i,
            ...
            l,
            f,
            h = G.PriorityQueue.make();
          for (h.push(e, 0); !h.empty(); )
            for (a in ((s = (i = h.pop()).value),
            (u = i.cost),
            (c = t[s] || {})))
              c.hasOwnProperty(a) &&
                ((l = u + c[a]),
        ...
        find_path: function (t, e, n) {
          var r = G.single_source_shortest_paths(t, e, n);
          return G.extract_shortest_path_from_predecessor_list(r, n);
        },
        PriorityQueue: {
          make: function (t) {
            var e,
...
!(function (t) {
  ...
  function h(t) {
    const n = f(a.NUMERIC, e.NUMERIC, t),
      r = f(a.ALPHANUMERIC, e.ALPHANUMERIC, t);
    let o, i;
    u.isKanjiModeEnabled()
      ? ((o = f(a.BYTE, e.BYTE, t)), (i = f(a.KANJI, e.KANJI, t)))
      : ((o = f(a.BYTE_KANJI, e.BYTE, t)), (i = []));
    return n
      .concat(r, o, i)
      .sort(function (t, e) {
  ...
  function d(t, n) {
    ...
    if (((a = e.from(n, c)), a !== e.BYTE && a.bit < c.bit))
      throw new Error(
        '"' +
          t +
    ...
    switch ((a !== e.KANJI || u.isKanjiModeEnabled() || (a = e.BYTE), a)) {
      case e.NUMERIC:
        return new r(t);
      case e.ALPHANUMERIC:
        return new o(t);
          ...
          for (let r = 0; r < t.length; r++) {
            ...
            switch (o.mode) {
              ...
              case e.ALPHANUMERIC:
                ...
                break;
              case e.KANJI:
                n.push([o, { data: o.data, mode: e.BYTE, length: l(o.data) }]);
                break;
              case e.BYTE:
                n.push([{ data: o.data, mode: e.BYTE, length: l(o.data) }]);
            }
          }
          return n;
        })(h(n, u.isKanjiModeEnabled())),
        i = (function (t, n) {
          const r = {},
            o = { start: {} };
          let i = ["start"];
            ...
            for (let t = 0; t < a.length; t++) {
              ...
              for (let t = 0; t < i.length; t++) {
                ...
                r[s] && r[s].node.mode === c.mode
                  ? ((o[s][l] =
                      g(r[s].lastCount + c.length, c.mode) -
                      g(r[s].lastCount, c.mode)),
...
function mt(t, e, n) {
  ...
  n.forEach(function (e) {
    (r.put(e.mode.bit, 4),
      r.put(e.getLength(), dt.getCharCountIndicator(e.mode, t)),
      e.write(r));
  });
  const o =
    8 * (rt.getSymbolTotalCodewords(t) - lt.getTotalCodewordsCount(t, e));
  for (
  ...
  return (function (t, e, n) {
    const r = rt.getSymbolTotalCodewords(e),
      o = lt.getTotalCodewordsCount(e, n),
      i = r - o,
      s = lt.getBlocksCount(e, n),
      a = r % s,
      u = s - a,
      c = Math.floor(r / s),
      l = Math.floor(i / s),
    ...
    let A,
      ...
      C = 0;
    for (A = 0; A < m; A++)
      for (v = 0; v < s; v++) A < p[v].length && (y[C++] = p[v][A]);
    for (A = 0; A < h; A++) for (v = 0; v < s; v++) y[C++] = w[v][A];
    return y;
  })(r, t, e);
}
function Et(t, e, n, r) {
  let o;
  if (Array.isArray(t)) o = pt.fromArray(t);
  else {
    if ("string" != typeof t) throw new Error("Invalid data");
    {
      let r = e;
      if (!r) {
        const e = pt.rawSplit(t);
        r = ht.getBestVersionForData(e, n);
      }
      o = pt.fromString(t, r || 40);
    }
  }
  const i = ht.getBestVersionForData(o, n);
  if (!i)
  ...
  return (
    ...
    isNaN(r) && (r = ct.getBestMask(u, wt.bind(null, u, n))),
    ct.applyMask(r, u),
    wt(u, n, r),
    {
      modules: u,
...
e.create = function (t, e) {
  ...
  return (
    void 0 !== e &&
      ((o = ot.from(e.errorCorrectionLevel, ot.M)),
      (n = ht.from(e.version)),
      (r = ct.from(e.maskPattern)),
      e.toSJISFunc && rt.setToSJISFunction(e.toSJISFunc)),
    Et(t, n, o, r)
  );
};
var yt = {},
...
vt.render = function (t, e, n) {
  const r = Ct.getOptions(e),
    o = t.modules.size,
    i = t.modules.data,
    s = o + 2 * r.margin,
    a = r.color.light.a
      ? "<path " +
        Bt(r.color.light, "fill") +
        ' d="M0 0h' +
        s +
        "v" +
        s +
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          (u || i || (i = !0),
            t[a]
              ? (s++,
                (a > 0 && u > 0 && t[a - 1]) ||
                  ((r += i ? It("M", u + n, 0.5 + c + n) : It("m", o, 0)),
                  (o = 0),
                  (i = !1)),
                (u + 1 < e && t[a + 1]) || ((r += It("h", s)), (s = 0)))
              : o++);
        }
        return r;
      })(i, o, r.margin) +
...
function bt(t, e, n, r, o) {
  ...
  if (!a && !Mt()) throw new Error("Callback required as last argument");
  if (!a) {
...
((t.create = Tt.create),
  (t.toCanvas = bt.bind(null, Nt.render)),
  (t.toDataURL = bt.bind(null, Nt.renderToDataURL)),
  (t.toString = bt.bind(null, function (t, e, n) {
    return Pt.render(t, n);
  })));
export { t as b };
